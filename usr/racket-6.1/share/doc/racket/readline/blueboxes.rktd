960
((3) 0 () 2 ((q lib "readline/readline.rkt") (q lib "readline/pread.rkt")) () (h ! (equal) ((c def c (c (? . 0) q set-completion-function!)) q (1118 . 5)) ((c def c (c (? . 1) q readline-prompt)) q (498 . 4)) ((c def c (c (? . 0) q history-delete)) q (1052 . 3)) ((c def c (c (? . 0) q readline)) q (671 . 3)) ((q def ((lib "readline/main.rkt") install-readline!)) q (0 . 2)) ((c def c (c (? . 0) q history-length)) q (930 . 2)) ((c def c (c (? . 0) q readline-redisplay)) q (1365 . 2)) ((c def c (c (? . 1) q keep-duplicates)) q (255 . 4)) ((c def c (c (? . 0) q add-history-bytes)) q (865 . 3)) ((c def c (c (? . 0) q readline-bytes)) q (736 . 3)) ((c def c (c (? . 0) q add-history)) q (805 . 3)) ((c def c (c (? . 1) q max-history)) q (134 . 4)) ((c def c (c (? . 1) q keep-blanks)) q (408 . 4)) ((c def c (c (? . 0) q history-get)) q (989 . 3)) ((c def c (c (? . 0) q readline-newline)) q (1325 . 2)) ((c def c (c (? . 1) q current-prompt)) q (41 . 4))))
procedure
