1141
((3) 0 () 7 ((q lib "macro-debugger/expand.rkt") (q lib "macro-debugger/analysis/check-requires.rkt") (q lib "macro-debugger/syntax-browser.rkt") (q lib "macro-debugger/analysis/show-dependencies.rkt") (q lib "macro-debugger/emit.rkt") (q lib "macro-debugger/stepper-text.rkt") (q lib "macro-debugger/stepper.rkt")) () (h ! (equal) ((c def c (c (? . 4) q emit-local-step)) q (983 . 5)) ((c def c (c (? . 0) q expand-only)) q (130 . 4)) ((c def c (c (? . 3) q get-dependencies)) q (3106 . 9)) ((c def c (c (? . 0) q expand/hide)) q (259 . 4)) ((c def c (c (? . 6) q expand/step)) q (0 . 3)) ((c def c (c (? . 1) q check-requires)) q (1640 . 11)) ((c def c (c (? . 1) q show-requires)) q (2310 . 6)) ((c def c (c (? . 5) q stepper-text)) q (1303 . 5)) ((c def c (c (? . 2) q browse-syntax)) q (1502 . 3)) ((c def c (c (? . 2) q browse-syntaxes)) q (1564 . 3)) ((c def c (c (? . 3) q show-dependencies)) q (2572 . 10)) ((c def c (c (? . 0) q expand/show-predicate)) q (378 . 4)) ((c def c (c (? . 4) q emit-remark)) q (497 . 10)) ((c def c (c (? . 5) q expand/step-text)) q (1115 . 5)) ((c def c (c (? . 6) q expand-module/step)) q (58 . 3))))
procedure
