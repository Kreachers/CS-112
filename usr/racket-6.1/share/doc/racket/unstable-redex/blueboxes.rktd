1053
((3) 0 () 1 ((q lib "unstable/gui/redex.rkt")) () (h ! (equal) ((c def c (c (? . 0) q current-atomic-rewriters)) q (65 . 11)) ((c def c (c (? . 0) q postfix-rw)) q (2612 . 7)) ((c def c (c (? . 0) q compound-rewriter/c)) q (1566 . 2)) ((c def c (c (? . 0) q constant-rw)) q (3159 . 3)) ((c def c (c (? . 0) q only-first-rw)) q (3061 . 2)) ((c def c (c (? . 0) q add-unquote-rewriters!)) q (1346 . 3)) ((c def c (c (? . 0) q current-unquote-rewriters)) q (749 . 5)) ((c def c (c (? . 0) q bracket-rw)) q (3288 . 6)) ((c def c (c (? . 0) q add-atomic-rewriters!)) q (949 . 6)) ((c def c (c (? . 0) q binary-rw)) q (1606 . 13)) ((c def c (c (? . 0) q splice-rw)) q (3112 . 2)) ((c def c (c (? . 0) q function-rw)) q (2932 . 3)) ((c def c (c (? . 0) q prefix-rw)) q (2295 . 7)) ((c def c (c (? . 0) q plistof)) q (1465 . 4)) ((c def c (c (? . 0) q with-rewriters)) q (0 . 3)) ((c def c (c (? . 0) q set-cons-rw)) q (3567 . 2)) ((c def c (c (? . 0) q add-compound-rewriters!)) q (1230 . 3)) ((c def c (c (? . 0) q current-compound-rewriters)) q (555 . 5))))
procedure
